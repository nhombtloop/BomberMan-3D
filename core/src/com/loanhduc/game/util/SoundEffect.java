...
public class SoundEffect {
    private static Sound boom = Gdx.audio.newSound(Gdx.files.internal("explode.mp3"));
    ...
    private static Sound eatItem = Gdx.audio.newSound(Gdx.files.internal("coin.wav"));
