...
public class WinGame extends ScreenAdapter {
    ...
    public WinGame(BoomGame game) {
        this.game = game;
    }
    public void show() {
        int buttonOffset = 15;
        backgroundImg = new Texture(Gdx.files.internal("win.jpg"));
        ...
        newGameButton.setPosition(Gdx.graphics.getWidth() - Gdx.graphics.getWidth()*12/13 + 75,130);
...
//        exitButton.setPosition(Gdx.graphics.getWidth()/2 - Gdx.graphics.getWidth()/8,Gdx.graphics.getHeight()/2);
        exitButton.setPosition(Gdx.graphics.getWidth() - Gdx.graphics.getWidth()/2 + 30,130);
